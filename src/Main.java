...
public class Main{
    public static void main(String[] args) {
        ...
        lesh.action(ActionType.collect, " money");
        som.action(ActionType.bought, " food");
        syd.action(ActionType.folded, " in bag");
        ponch.action(ActionType.will_eat, " food");
        ...
        Train.Railway_carriage rail = train.new Railway_carriage("Railway_carriage");
